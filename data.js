    ...
    fixedGroups: (ltvPct) => [
      ...
      },
      {
        ...
        items: [
          ...
          "Note: for highly leveraged scenarios (e.g. 25% down with high mortgage rates), net cash flows are often negative throughout — Reinvested and Additive modes produce identical results since there is no positive pool to compound",
    ...
    fixedGroups: (ltvPct) => [
      ...
      },
      {
        ...
        items: [
          ...
          "注意：高杠杆方案（如高利率下首付25%）的净现金流往往全程为负——此时复投与叠加结果相同，因无正值现金流可复投",
